...
<html <?php language_attributes(); ?>>
  ...
  <style>
    .jumbotron {
      background: url(<?php echo get_theme_mod('banner_image', get_bloginfo('template_url') .'/assets/img/banner.jpg'); ?>) 0 -80px;
    }
  </style>
  <body <?php body_class(); ?>>
        ...
        <div class="container">
          <?php
            wp_nav_menu(array(
              ...
              'depth'           => 2,
              'container'       => false,
              'menu_class'      => 'nav navbar-pills nav-pills float-right',

...
$wp_customize->add_setting('banner_btn_url', array(
  'default'	=> 	_x('https://www.udemy.com/', 'business'),
  'type'		=> 	'theme_mod'
));
...
//Box 1 
  ...
  $wp_customize->add_section('box1_heading', array(
  ...
  //Box 1 Text Setting
  $wp_customize->add_section('box1_text', array(
  ...
  //Box 1 Icon Setting
  $wp_customize->add_section('box1_icon', array(
  ...
  $wp_customize->add_control('box1_icon', array(
    'default'	=> 	_x('Box 1 Icon', 'business'),
    'section'		=>	'boxes',
    'priority'		=> 20
  ));
...
//Box 2 Section 
  ...
  $wp_customize->add_section('box2_heading', array(
  ...
  //Box 2 Text Setting
  $wp_customize->add_section('box2_text', array(
    'default'	=> 	_x('Maecenas sed diam eget risus varius blandit sit amet non magna.', 'business'),
    'type'		=> 	'theme_mod'
  ));
  ...
  $wp_customize->add_control('box2_text', array(
    'default'	=> 	_x('Box 2 Text', 'business'),
    'section'		=>	'boxes',
    'priority'		=> 20
  ));

  //Box 2 Icon Setting
  $wp_customize->add_section('box2_icon', array(
    'default'	=> 	_x('bar-chart', 'business'),
    'type'		=> 	'theme_mod'
  ));
  ...
  $wp_customize->add_control('box2_icon', array(
    'default'	=> 	_x('Box 2 Icon', 'business'),
    'section'		=>	'boxes',
    'priority'		=> 20
  ));
...
//Box 3 Section 
  ...
  $wp_customize->add_section('box3_heading', array(
  ...
  //Box 3 Text Setting
  $wp_customize->add_section('box3_text', array(
    'default'	=> 	_x('Maecenas sed diam eget risus varius blandit sit amet non magna.', 'business'),
    'type'		=> 	'theme_mod'
  ));
  ...
  $wp_customize->add_control('box3_text', array(
    'default'	=> 	_x('Box 3 Text', 'business'),
    'section'		=>	'boxes',
    'priority'		=> 20
  ));

  //Box 3 Icon Setting
  $wp_customize->add_section('box3_icon', array(
    'default'	=> 	_x('bar-chart', 'business'),
    'type'		=> 	'theme_mod'
  ));
  ...
  $wp_customize->add_control('box3_icon', array(
    'default'	=> 	_x('Box 3 Icon', 'business'),
    'section'		=>	'boxes',
    'priority'		=> 20
  ));
